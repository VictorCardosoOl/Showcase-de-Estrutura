...
export const HeroSection = ({ nicheId, currentNiche, SectionWrapper, XrayMarker }: any) => (
  <SectionWrapper id="hero" className="relative bg-brand-dark text-brand-yellow overflow-hidden min-h-[max(80vh,600px)] flex flex-col">
    ...
    <div className="relative z-10 flex-grow flex flex-col justify-center max-w-7xl mx-auto px-[clamp(1.5rem,5vw,3rem)] w-full pt-20 pb-[clamp(4rem,10vw,8rem)]">
      <div className="max-w-2xl mb-[clamp(2rem,8vw,8rem)]">
...
export const AboutSection = ({ currentNiche, monthlyRevenue, optimizedRevenue, SectionWrapper, XrayMarker }: any) => (
  <SectionWrapper id="none" htmlId="sobre-nos" className="bg-brand-olive text-brand-yellow py-[clamp(4rem,10vw,8rem)]">
    <XrayMarker id="features" position="top-8 left-8" />
    <div className="max-w-7xl mx-auto px-[clamp(1.5rem,5vw,3rem)]">
      <div className="grid lg:grid-cols-12 gap-[clamp(2rem,5vw,3rem)]">
        ...
        <div className="lg:col-span-9">
          <h2 className="text-[clamp(1.75rem,4vw,3rem)] font-medium leading-tight mb-[clamp(2rem,6vw,4rem)] max-w-4xl">
...
export const FeaturesSection = ({ currentNiche, FeatureCard }: any) => (
  <div className="bg-brand-light text-brand-dark py-[clamp(4rem,10vw,8rem)]">
    <div className="max-w-7xl mx-auto px-[clamp(1.5rem,5vw,3rem)]">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-[clamp(2rem,6vw,4rem)] gap-8">
        <h2 className="text-[clamp(2rem,5vw,3.75rem)] font-medium tracking-tight max-w-2xl leading-tight">
...
export const CasesSection = ({ nicheId, currentNiche }: any) => (
  <div id="planos" className="bg-brand-light text-brand-dark pb-[clamp(4rem,10vw,8rem)]">
    <div className="max-w-7xl mx-auto px-[clamp(1.5rem,5vw,3rem)]">
...
export const FooterSection = () => (
  <footer className="bg-brand-dark text-brand-yellow py-[clamp(4rem,8vw,6rem)]">
    <div className="max-w-7xl mx-auto px-[clamp(1.5rem,5vw,3rem)]">
